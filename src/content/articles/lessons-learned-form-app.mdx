...
snippet:
    'Pozornie prosty pomsył może szybko przekształcić się w potworka na którego nie chce się patrzeć. Na stół weźmiemy FormApp, prostą aplikację do tworzenia harmonogramów wizyt. Przedstawię Ci decyzje, które podjąłem podczas tworzenia tego projektu i pokażę, dlaczego uważam, że nie wszystkie były szczęśliwe.'
